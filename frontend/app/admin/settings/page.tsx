...
export default function AdminSettingsPage() {
  ...
  if (loading || !settings) {
    return (
      <div className="max-w-lg">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 h-80 animate-pulse" />
      </div>
    );
  }
  ...
  return (
    <div className="max-w-lg">
      <h1 className="text-2xl font-bold text-black mb-1">Platform Fee Settings</h1>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full border border-gray-200 p-2.5 pr-9 rounded-lg text-black focus:outline-none focus:ring-2 focus:ring-pink-400/40 focus:border-pink-400"
              />
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full border border-gray-200 p-2.5 pl-8 rounded-lg text-black focus:outline-none focus:ring-2 focus:ring-pink-400/40 focus:border-pink-400"
              />
            </div>
          </div>
        )}

        <div className="flex gap-2 bg-yellow-50 border border-yellow-200 text-yellow-800 text-xs rounded-xl p-3">
